                ...
                <ul className="cart-items">
                    ...
                    {cartItems.map(item => (
                        <li key={item.id} className="cart-item">
                            ...
                            <div className="quantity-contorls">
                                <button className="quantity-contorl-btn" onClick={() => handleDecreaseQuantity(item.id)}>-</button>
                                <span>{item.quantity}</span>
                                <button className="quantity-contorl-btn" onClick={() => handleIncreaseQuantity(item.id)}>+</button>
                            </div>
